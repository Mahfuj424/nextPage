...
const Home = () => {
  return (
    <div>
      <div className="flex flex-col items-center justify-between lg:flex-row mt-10 px-8">
        {/* Text Content */}
        <div className="mb-10 lg:max-w-lg  lg:pr-5 lg:mb-0">
          <div className="max-w-xl mb-6 lg:mt-8">
            <div>
              <p className="badge bg-orange-500 border-none">On Sale!</p>
            </div>
          ...
          <div className="flex flex-col items-center md:flex-row">
            <Link to="/books" className="btn btn-primary md:w-auto md:mr-4">
