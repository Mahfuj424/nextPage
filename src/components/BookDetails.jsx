...
const BookDetails = () => {
    ...
    return (
        <div>
            <div className='flex flex-col mt-20 max-w-screen-lg overflow-hidden bg-white border rounded shadow-sm lg:flex-row sm:mx-auto'>
                {/* Image Container */}
                ...
                <div className=' p-8 bg-white lg:p-16 lg:pl-10 lg:w-1/2'>
                    <div>
                        <p className='badge bg-orange-500'>Brand new</p>
                    </div>
